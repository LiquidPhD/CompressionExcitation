function [frequencyFilteredPV] = frequencyFilteringTesting(particleVelocity,BScan,Parameters,xaxis,firstFreq,secondFreq)
...
% position = wait(h);
b = fir1(100,[firstFreq*2*Ts (firstFreq+secondFreq)*2*Ts]);
