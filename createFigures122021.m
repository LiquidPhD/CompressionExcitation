...
figure;
imagesc(xaxis,zaxis(1:670),abs(strain_whole(1:670,:))/1000); colormap(hot); colorbar; 
caxis([CLow CHigh])
xlabel('Distance (mm)')
ylabel('Depth (mm)')
title('Strain')
...
strainStack(:,:,imageIterator) = abs(strain_whole)/1000;
...
figure; imagesc(YMTotal/10000); colormap(jet); caxis([0 500])
...
YMLeftAvg2 = mean(YMLeft/10000,'all','omitnan')
YMRightAvg2 = mean(YMRight/10000,'all','omitnan')
...
YMTotalSmoothed = fitted_displacement/10000;
